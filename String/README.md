- startsWith("character") : Chuỗi có bắt đầu với character này không , Nếu có --> true
==============================
- Truy cập qua index: .charAt(index) / .at(index) / [index]
- In vị trí đầu tiên của ký tự: .indexOf(ký tự)
- In vị trí cuối cùng của ký tự: .lastIndexOf(ký tự)
...
==============================
- Loại bỏ khoảng trắng 2 đầu: .trim()
